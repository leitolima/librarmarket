...
export default function NavBar(){
    ...
    const carpetas = "MLA1051";
    const lapices = "MLA1144";
    const marcadores = "MLA1648";
    const papeleria = "MLA1010";
    ...
    <AppBar position="static" style={{flexGrow:1, backgroundColor: "#D4ed31"}}>
        <Toolbar> 
            ...
            <Typography variant="h6"  >
                <Button>
                    <Link style={StyledLinks} to={`/category/${lapices}`}>Lapices</Link>
                </Button>
            </Typography>
            <Typography variant="h6" >
                <Button>
                    <Link style={StyledLinks} to={`/category/${carpetas}`}>Carpetas</Link>
                </Button>
            </Typography>
            <Typography variant="h6"  >
                <Button>
                    <Link style={StyledLinks} to={`/category/${marcadores}`}>Marcadores</Link>
                </Button>
            </Typography>
            <Typography variant="h6"  >
                <Button>
                    <Link style={StyledLinks} to={`/category/${papeleria}`}>Papelería</Link>
                </Button>
            </Typography>
